...
(() => {
        ...
        !(function () {
                  ...
                  t(n, [
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        (e || (this._inertManager.setInert(t, !0), (e = this._inertManager.getInertRoot(t))),
                        ...
                        if (this.node.nodeType === Node.ELEMENT_NODE) {
                          ...
                          if (a.call(t, s)) {
                            ...
                            (t.hasAttribute("tabindex") && (this._savedTabIndex = t.tabIndex),
                              ...
                              t.nodeType === Node.ELEMENT_NODE && ((t.focus = function () {}), (this._overrodeFocusMethod = !0)));
                ...
                function s(t) {
                  ...
                  ((this._document = t),
                    ...
                    "loading" === t.readyState
                      ? t.addEventListener("DOMContentLoaded", this._onDocumentLoaded.bind(this))
          ...
          function h(t, e, i) {
            if (t.nodeType == Node.ELEMENT_NODE) {
              ...
              if ("slot" == a.localName) {
                for (var l = a, d = l.assignedNodes ? l.assignedNodes({ flatten: !0 }) : [], c = 0; c < d.length; c++) h(d[c], e, i);
                return;
              }
            }
  ...
  ((() => {
    "use strict";
    (i.r(a), i.d(a, { Timeline: () => Zi, exportJSON: () => Vi, lookupMediaType: () => Hi, parseGoogleSpreadsheetURL: () => Xe }));
    ...
    const f =
      window && !window.L_NO_TOUCH && !s && (c || "ontouchstart" in window || (window.DocumentTouch && document instanceof window.DocumentTouch));
    function g(t) {
    ...
    function b(t) {
      for (var e = { x: 0, y: 0 }; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop); )
    ...
    function R(t, ...e) {
      for (let a of e) for (var i of Object.getOwnPropertyNames(a.prototype)) t.prototype[i] = a.prototype[i];
    }
    function j(t) {
      t = (t = O(t)).toLowerCase();
      for (var e = 0; e < 31; e++)
    ...
    function $(t, e, i) {
      ...
      return t
        .replace(/\b(?:https?|ftp):\/\/([a-z0-9-+&@#\/%?=~_|!:,.;]*[a-z0-9-+&@#\/%=~_|])/gim, function (t, e, i, s) {
          if (i > 0) {
            var n = s[i - 1];
            if ('"' == n || "'" == n || "=" == n) return t;
          }
    ...
    let G =
      ((Z = (Y = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length),
      {
        encode: function (t) {
    ...
    it.extend = function (t) {
      ...
      var a = new i();
      for (var s in ((a.constructor = e), (e.prototype = a), (e.superclass = this.prototype), this))
        this.hasOwnProperty(s) && "prototype" !== s && "superclass" !== s && (e[s] = this[s]);
      return (
        t.statics && (L(e, t.statics), delete t.statics),
        t.includes && (L.apply(null, [a].concat(t.includes)), delete t.includes),
    ...
    class at {
      on(t, e, i) {
        ...
        return ((a[t] = a[t] || []), a[t].push({ action: e, context: i || this }), this);
      }
      ...
      fire(t, e) {
        if (!this.hasEventListeners(t)) return this;
        for (var i = E({ type: t, target: this }, e), a = this._tl_events[t].slice(), s = 0, n = a.length; s < n; s++)
          a[s].action ? a[s].action.call(a[s].context || this, i) : D(`no action defined for ${t} listener`);
        return this;
      }
    }
    function st(t, e) {
    ...
    const nt = (function () {
      var t = document,
        ...
        f = (function () {
          ...
          for (e = 0; e < a.length; e++) if (a[e] in i) return a[e];
        })(),
      ...
      function k(t, e) {
        var i,
          a = {};
        return (
          (i = t.match(c)) && (a.rotate = A(i[1], e ? e.rotate : null)),
          (i = t.match(u)) && (a.scale = A(i[1], e ? e.scale : null)),
          (i = t.match(m)) && ((a.skewx = A(i[1], e ? e.skewx : null)), (a.skewy = A(i[3], e ? e.skewy : null))),
          (i = t.match(_)) && ((a.translatex = A(i[1], e ? e.translatex : null)), (a.translatey = A(i[3], e ? e.translatey : null))),
          a
        );
      }
      function x(t) {
      ...
      function T(t) {
        var e,
          i,
          a,
          s = t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);
        return (s ? ((e = s[1]), (i = s[2]), (a = s[3]), "#" + ((1 << 24) | (e << 16) | (i << 8) | a).toString(16).slice(1)) : t).replace(
          /#(\w)(\w)(\w)$/,
          "#$1$1$2$2$3$3"
        );
      }
      ...
      function D(t, e) {
        ...
        for (a = 1; a < s; ++a)
          for (i = 0; i < s - a; ++i)
            ((n[i][0] = (1 - e) * n[i][0] + e * n[parseInt(i + 1, 10)][0]), (n[i][1] = (1 - e) * n[i][1] + e * n[parseInt(i + 1, 10)][1]));
        return [n[0][0], n[0][1]];
      }
      function N(t, e, i, a, s, n, o) {
        ...
        return "string" == typeof i[n][s]
          ...
          : ((o = Math.round(((a[n][s] - i[n][s]) * t + i[n][s]) * r) / r), s in p || (o += e[n][s] || "px"), o);
      }
        ...
        for (c && ((a = e.left), (s = e.top), delete e.right, delete e.bottom, delete e.left, delete e.top), i = n.length; i--; ) {
          ...
          for (var L in e) {
            ...
            var I,
              C = v(n[i], L),
              O = E(e[L]) ? e[L](n[i]) : e[L];
            "string" != typeof O || !l.test(O) || l.test(C)
              ? ((u[i][L] = "transform" == L ? k(C) : "string" == typeof O && l.test(O) ? T(C).slice(1) : parseFloat(C)),
                (m[i][L] = "transform" == L ? k(O, u[i][L]) : "string" == typeof O && "#" == O.charAt(0) ? T(O).slice(1) : A(O, parseFloat(C))),
                "string" == typeof O && (I = O.match(d)) && (_[i][L] = I[1]))
              : delete e[L];
          }
        }
        return S.apply(n, [
          ...
          function (t, a, s) {
            for (i = n.length; i--; )
              for (var o in (c && ((s = D(p[i], t)), (n[i].style.left = s[0] + "px"), (n[i].style.top = s[1] + "px")), e))
                ((a = N(t, _, u, m, o, i)),
                  "transform" == o
                    ? (n[i].style[f] = x(a))
                    : "opacity" != o || g
                      ? (n[i].style[M(o)] = a)
                      : (n[i].style.filter = "alpha(opacity=" + 100 * a + ")"));
          },
          o,
          h,
        ]);
    ...
    class rt {
      ...
      _animateMomentum() {
        var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
          e = { duration: this.options.duration, easing: tt };
        (this.options.enable.y &&
          ((this.options.constraint.top || this.options.constraint.bottom) &&
            (t.y > this.options.constraint.bottom
              ? (t.y = this.options.constraint.bottom)
              : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)),
          ...
          this.options.enable.x &&
            ((this.options.constraint.left || this.options.constraint.right) &&
              (t.x > this.options.constraint.left
                ? (t.x = this.options.constraint.left)
                : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)),
    ...
    var lt,
      ht = {
        ...
        removeListener: function (t, e, i) {
          var a = A(i),
            ...
            n = t[s];
          n &&
            (f && "dblclick" === e && this.removeDoubleTapListener
              ? this.removeDoubleTapListener(t, a)
              : "removeEventListener" in t
                ? "mousewheel" === e
                  ? (t.removeEventListener("DOMMouseScroll", n, !1), t.removeEventListener(e, n, !1))
                  : "mouseenter" === e || "mouseleave" === e
                    ? t.removeEventListener("mouseenter" === e ? "mouseover" : "mouseout", n, !1)
      ...
      dt = (function () {
        var t,
          ...
          w = { tr: h.createElement("tbody"), tbody: y, thead: y, tfoot: y, td: b, th: b, "*": h.createElement("div") },
        ...
        function q(i, a, s) {
          for (e in a)
            s && (R(a[e]) || D(a[e]))
              ? (R(a[e]) && !R(i[e]) && (i[e] = {}), D(a[e]) && !D(i[e]) && (i[e] = []), q(i[e], a[e], s))
              : a[e] !== t && (i[e] = a[e]);
        }
        function $(t, e) {
        ...
        function G(t) {
          ...
          try {
            return t
              ? "true" == t ||
                  ("false" != t && ("null" == t ? null : /^0/.test(t) || isNaN((e = Number(t))) ? (/^[\[\{]/.test(t) ? i.parseJSON(t) : t) : e))
              : t;
          } catch (e) {
            return t;
          }
        ...
        return (
          ...
          (E.fragment = function (e, a, s) {
            var n, o, l;
            return (
              _.test(e) && (n = i(h.createElement(RegExp.$1))),
              n ||
          ...
          (E.qsa = function (t, e) {
            ...
            return C(t) && o && a
              ...
              : 1 !== t.nodeType && 9 !== t.nodeType
                ? []
                : r.call(o && !a ? (s ? t.getElementsByClassName(n) : t.getElementsByTagName(e)) : t.querySelectorAll(e));
          }),
          ...
          (i.map = function (t, e) {
            var a,
              ...
              o,
              r = [];
            if (j(t)) for (s = 0; s < t.length; s++) null != (a = e(t[s], s)) && r.push(a);
            else for (n in t) null != (a = e(t[n], n)) && r.push(a);
          ...
          (i.fn = {
            ...
            each: function (t) {
              return (
                o.every.call(this, function (e, i) {
            ...
            wrapAll: function (t) {
              if (this[0]) {
                var e;
                for (i(this[0]).before((t = i(t))); (e = t.children()).length; ) t = e.first();
                i(t).append(this);
              }
              return this;
            },
            ...
            attr: function (i, a) {
              var s;
              return "string" == typeof i && a === t
                ? 0 == this.length || 1 !== this[0].nodeType
                  ? t
                  : "value" == i && "INPUT" == this[0].nodeName
                    ? this.val()
                    : !(s = this[0].getAttribute(i)) && i in this[0]
                      ? this[0][i]
                      : s
                : this.each(function (t) {
                    if (1 === this.nodeType)
                      if (O(i)) for (e in i) B(this, e, i[e]);
              ...
              if (t)
                return this.each(function (e) {
                  var a = i(this),
                    ...
                    o = { top: s.top - n.top, left: s.left - n.left };
            ...
            position: function () {
              if (this.length) {
                var t = this[0],
                  e = this.offsetParent(),
                  a = this.offset(),
                  s = f.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset();
                return (
                  (a.top -= parseFloat(i(t).css("margin-top")) || 0),
                  ...
                  { top: a.top - s.top, left: a.left - s.left }
                );
              }
            },
    ...
    ((window.Zepto = dt),
      ...
      (function (t) {
        ...
        function k(i, a) {
          return (
            (!a && i.isDefaultPrevented) ||
              ...
              (a.defaultPrevented !== e
                ? a.defaultPrevented
                : "returnValue" in a
                  ? !1 === a.returnValue
                  : a.getPreventDefault && a.getPreventDefault()) && (i.isDefaultPrevented = v)),
            i
          );
        }
        function x(t) {
        ...
        ((t.fn.delegate = function (t, e, i) {
                ...
                u.each(function (e, s) {
                  (h &&
                    ...
                    o &&
                      (c = function (e) {
                        var i,
                          n = t(e.target).closest(o, s).get(0);
                        if (n && n !== s)
                          return ((i = t.extend(x(e), { currentTarget: n, liveFired: s })), (d || l).apply(n, [i].concat(a.call(arguments, 1))));
                      }),
                    f(s, i, l, r, o, c || d));
                }));
          }),
          ...
          (t.fn.trigger = function (e, i) {
            return (
              ((e = n(e) || t.isPlainObject(e) ? t.Event(e) : k(e))._args = i),
              this.each(function () {
          ...
          (t.Event = function (t, e) {
            ...
            var i = document.createEvent(r[t] || "Events"),
              a = !0;
            if (e) for (var s in e) "bubbles" == s ? (a = !!e[s]) : (i[s] = e[s]);
      ...
      (function (t) {
        ...
        function v(e, i, a, s) {
          ...
          return { url: e, data: n ? i : void 0, success: n ? (t.isFunction(a) ? a : void 0) : i, dataType: (n && s) || a };
        }
        ((t.active = 0),
          ...
          (t.ajax = function (a) {
            ...
            (!(function (e) {
              ...
              (function (e) {
                (e.processData && e.data && "string" != t.type(e.data) && (e.data = t.param(e.data, e.traditional)),
                  !e.data || (e.type && "GET" != e.type.toUpperCase()) || ((e.url = g(e.url, e.data)), (e.data = void 0)));
              })(s),
            ...
            if (
              ...
              k("Accept", b || "*/*"),
              (b = s.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(b)),
              (s.contentType || (!1 !== s.contentType && s.data && "GET" != s.type.toUpperCase())) &&
                k("Content-Type", s.contentType || "application/x-www-form-urlencoded"),
              s.headers)
            )
              for (i in s.headers) k(i, s.headers[i]);
            if (
              ((T.setRequestHeader = k),
              ...
              return (T.abort(), _(null, "abort", T, s, n), T);
            if (s.xhrFields) for (i in s.xhrFields) T[i] = s.xhrFields[i];
              ...
              ((e.onreadystatechange = function () {
                try {
                  ...
                  if (e.status >= 200 && e.status < 300) {
                    ...
                    i(s);
                  } else a({ status: e.status, statusText: e.statusText });
                } catch (e) {
                  a({ status: 400, statusText: `Error fetching JSON from ${t}: ${e}` });
                }
              }),
                e.open("GET", t, !0),
                e.send());
      ...
      ((lt = dt).fn.serializeArray = function () {
        var t,
          e = [];
        return (
          lt([].slice.call(this.get(0).elements)).each(function () {
    ...
    const ct = dt.getJSON,
      ...
      yt = it.extend({
        ...
        floor: function (t) {
          for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < _t.length; i++) if ((_t[i][2](e), _t[i][0] == t)) return new yt(e);
        ...
        findBestFormat: function (t) {
          for (var e = pt, i = 0; i < e.length; i++) if (this.data[e[i]]) return (t ? t in vt || (t = "short") : (t = "base"), vt[t][e[i]]);
          return "";
        },
    ...
    function bt(t) {
      ...
      if (
        (t.match(/\d+\/\d+/) && ((s = t.match(/\d+\/\d+/)[0]), (t = O(t.replace(s, ""))), (n = s.split("/")), (a.month = n[0]), (a.year = n[1])),
        t.match(":"))
      ) {
        var o = t.split(":");
    ...
    const Lt = [
      ...
      St = yt.extend({
        initialize: function (t, e, i) {
          (wt == t.constructor ? (this.data = { date_obj: t }) : ((this.data = JSON.parse(JSON.stringify(t))), this._createDateObj()),
            t.format && !e && (e = t.format),
            this._setFormat(e, i));
        },
        _createDateObj: function () {
        ...
        return t.constructor == Date
          ...
          : t.constructor == wt
            ...
            : t.data && t.data.date_obj
              ...
              : (D("Unfamiliar date presented for formatting"), t.toString());
      }
      formatJSDate(t, e) {
        var i = this,
          a = function (t, e) {
    ...
    ((Nt.fallback = { messages: {} }), (Nt.DATE_FORMAT_TOKENS = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g));
    var Ct = {
      en: {
      ...
      updateMessage(t) {
        ((this._el.message.innerHTML = t || this._("loading")),
          !this._el.parent.atributes &&
            ...
            (this.container.appendChild(this._el.container), (this._el.parent = this.container)));
      }
      updateDisplay(t, e) {}
      _onMouseClick() {
    ...
    const qt = { human: yt, cosmological: St },
      { entries: $t, setPrototypeOf: Ut, isFrozen: Bt, getPrototypeOf: Wt, getOwnPropertyDescriptor: Gt } = Object;
    let { freeze: Yt, seal: Zt, create: Vt } = Object,
      { apply: Xt, construct: Jt } = "undefined" != typeof Reflect && Reflect;
    (Yt ||
      (Yt = function (t) {
        return t;
      }),
    ...
    function fe(t) {
      const e = Vt(null);
      for (const [i, a] of $t(t))
        he(t, i) && (Array.isArray(a) ? (e[i] = pe(a)) : a && "object" == typeof a && a.constructor === Object ? (e[i] = fe(a)) : (e[i] = a));
      return e;
    }
    function ge(t, e) {
      for (; null !== t; ) {
    ...
    var qe = (function t() {
      ...
      let w,
        k = "";
      const { implementation: x, createNodeIterator: T, createDocumentFragment: M, getElementsByTagName: E } = a,
        { importNode: L } = s;
      let S = {
      ...
      const St = a.createElement("form"),
        ...
        Nt = function () {
          ...
          if (!Lt || Lt !== t) {
            if (
              ((t && "object" == typeof t) || (t = {}),
              (t = fe(t)),
              (Tt = -1 === Mt.indexOf(t.PARSER_MEDIA_TYPE) ? "text/html" : t.PARSER_MEDIA_TYPE),
              (Et = "application/xhtml+xml" === Tt ? se : ae),
              (P = he(t, "ALLOWED_TAGS") ? _e({}, t.ALLOWED_TAGS, Et) : H),
              (F = he(t, "ALLOWED_ATTR") ? _e({}, t.ALLOWED_ATTR, Et) : q),
              (yt = he(t, "ALLOWED_NAMESPACES") ? _e({}, t.ALLOWED_NAMESPACES, se) : bt),
              (ut = he(t, "ADD_URI_SAFE_ATTR") ? _e(fe(mt), t.ADD_URI_SAFE_ATTR, Et) : mt),
              (dt = he(t, "ADD_DATA_URI_TAGS") ? _e(fe(ct), t.ADD_DATA_URI_TAGS, Et) : ct),
              (lt = he(t, "FORBID_CONTENTS") ? _e({}, t.FORBID_CONTENTS, Et) : ht),
              (U = he(t, "FORBID_TAGS") ? _e({}, t.FORBID_TAGS, Et) : {}),
              (B = he(t, "FORBID_ATTR") ? _e({}, t.FORBID_ATTR, Et) : {}),
              (rt = !!he(t, "USE_PROFILES") && t.USE_PROFILES),
              (W = !1 !== t.ALLOW_ARIA_ATTR),
              (G = !1 !== t.ALLOW_DATA_ATTR),
              (Y = t.ALLOW_UNKNOWN_PROTOCOLS || !1),
              (Z = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR),
              (V = t.SAFE_FOR_TEMPLATES || !1),
              (X = !1 !== t.SAFE_FOR_XML),
              (J = t.WHOLE_DOCUMENT || !1),
              (tt = t.RETURN_DOM || !1),
              (et = t.RETURN_DOM_FRAGMENT || !1),
              (it = t.RETURN_TRUSTED_TYPE || !1),
              (Q = t.FORCE_BODY || !1),
              (at = !1 !== t.SANITIZE_DOM),
              (st = t.SANITIZE_NAMED_PROPS || !1),
              (nt = !1 !== t.KEEP_CONTENT),
              (ot = t.IN_PLACE || !1),
              (z = t.ALLOWED_URI_REGEXP || Oe),
              (gt = t.NAMESPACE || ft),
              (wt = t.MATHML_TEXT_INTEGRATION_POINTS || wt),
              (kt = t.HTML_INTEGRATION_POINTS || kt),
              ($ = t.CUSTOM_ELEMENT_HANDLING || {}),
              t.CUSTOM_ELEMENT_HANDLING && Dt(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && ($.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
              t.CUSTOM_ELEMENT_HANDLING &&
                Dt(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                ($.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
              t.CUSTOM_ELEMENT_HANDLING &&
              ...
              rt &&
                ((P = _e({}, Te)),
                (F = []),
                !0 === rt.html && (_e(P, ve), _e(F, Me)),
                !0 === rt.svg && (_e(P, ye), _e(F, Ee), _e(F, Se)),
                !0 === rt.svgFilters && (_e(P, be), _e(F, Ee), _e(F, Se)),
                !0 === rt.mathMl && (_e(P, ke), _e(F, Le), _e(F, Se))),
              t.ADD_TAGS && (P === H && (P = fe(P)), _e(P, t.ADD_TAGS, Et)),
              t.ADD_ATTR && (F === q && (F = fe(F)), _e(F, t.ADD_ATTR, Et)),
              t.ADD_URI_SAFE_ATTR && _e(ut, t.ADD_URI_SAFE_ATTR, Et),
              t.FORBID_CONTENTS && (lt === ht && (lt = fe(lt)), _e(lt, t.FORBID_CONTENTS, Et)),
              nt && (P["#text"] = !0),
              J && _e(P, ["html", "head", "body"]),
              P.table && (_e(P, ["tbody"]), delete U.tbody),
              ...
              (void 0 === w &&
                (w = (function (t, e) {
                  ...
                  try {
                    return t.createPolicy(s, { createHTML: (t) => t, createScriptURL: (t) => t });
                  } catch (t) {
                    return (console.warn("TrustedTypes policy " + s + " could not be created."), null);
                  }
                })(_, n)),
                null !== w && "string" == typeof k && (k = w.createHTML("")));
            (Yt && Yt(t), (Lt = t));
          }
        },
        At = _e({}, [...ye, ...be, ...we]),
        ...
        Ot = function (t, e) {
          try {
            ee(i.removed, { attribute: e.getAttributeNode(t), from: e });
          } catch (t) {
            ee(i.removed, { attribute: null, from: e });
          }
        ...
        Rt = function (t) {
          ...
          return (
            t && i && n.insertBefore(a.createTextNode(i), n.childNodes[0] || null),
            gt === ft ? E.call(e, J ? "html" : "body")[0] : J ? e.documentElement : n
          );
        },
        jt = function (t) {
          return T.call(
      ...
      const Ft = function (t) {
          ...
          if (
            (Ht(S.uponSanitizeElement, t, { tagName: a, allowedTags: P }),
            t.hasChildNodes() && !Pt(t.firstElementChild) && de(/<[/\w]/g, t.innerHTML) && de(/<[/\w]/g, t.textContent))
          )
            return (Ct(t), !0);
          ...
          return t instanceof h &&
            !(function (t) {
              let e = b(t);
              (e && e.tagName) || (e = { namespaceURI: gt, tagName: "template" });
                  ...
                  : t.namespaceURI === _t
                    ? e.namespaceURI === ft
                      ...
                      : e.namespaceURI === pt
                        ...
                        : Boolean(It[i])
                    : t.namespaceURI === ft
                      ? !(e.namespaceURI === pt && !kt[a]) && !(e.namespaceURI === _t && !wt[a]) && !It[i] && (xt[i] || !At[i])
                      : !("application/xhtml+xml" !== Tt || !yt[t.namespaceURI]))
              );
            })(t)
            ? (Ct(t), !0)
            : ("noscript" !== a && "noembed" !== a && "noframes" !== a) || !de(/<\/no(script|embed|frames)/i, t.innerHTML)
              ? (V &&
                  3 === t.nodeType &&
                  ((e = t.textContent),
                  Kt([D, N, A], (t) => {
                  ...
                  t.textContent !== e && (ee(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
                Ht(S.afterSanitizeElements, t, null),
                !1)
              : (Ct(t), !0);
        },
        qt = function (t, e, i) {
          ...
          if (G && !B[e] && de(I, e));
            ...
            if (
              !(
                (Ut(t) &&
                  (($.tagNameCheck instanceof RegExp && de($.tagNameCheck, t)) || ($.tagNameCheck instanceof Function && $.tagNameCheck(t))) &&
                  (($.attributeNameCheck instanceof RegExp && de($.attributeNameCheck, e)) ||
                    ($.attributeNameCheck instanceof Function && $.attributeNameCheck(e)))) ||
                ("is" === e &&
                  $.allowCustomizedBuiltInElements &&
                  (($.tagNameCheck instanceof RegExp && de($.tagNameCheck, i)) || ($.tagNameCheck instanceof Function && $.tagNameCheck(i))))
              )
            )
              return !1;
          } else if (ut[e]);
        ...
        Bt = function (t) {
          ...
          if (!e || zt(t)) return;
          const a = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: F, forceKeepAttr: void 0 };
          let s = e.length;
          for (; s--; ) {
            const n = e[s],
            ...
            if (
              ...
              Ht(S.uponSanitizeAttribute, t, a),
              (d = a.attrValue),
              !st || ("id" !== h && "name" !== h) || (Ot(o, t), (d = "user-content-" + d)),
              X && de(/((--!?|])>)|<\/(style|title)/i, d))
            ) {
              Ot(o, t);
              continue;
            }
        ...
        Wt = function t(e) {
          let i = null;
          const a = jt(e);
          for (Ht(S.beforeSanitizeShadowDOM, e, null); (i = a.nextNode()); )
            (Ht(S.uponSanitizeShadowNode, i, null), Ft(i), Bt(i), i.content instanceof o && t(i.content));
      ...
      return (
        (i.sanitize = function (t) {
          ...
          if ((K || Nt(e), (i.removed = []), "string" == typeof t && (ot = !1), ot)) {
            ...
            ((a = Rt("\x3c!----\x3e")),
              (n = a.ownerDocument.importNode(t, !0)),
              (1 === n.nodeType && "BODY" === n.nodeName) || "HTML" === n.nodeName ? (a = n) : a.appendChild(n));
          else {
          ...
          if (ot) return t;
          if (tt) {
            if (et) for (h = M.call(a.ownerDocument); a.firstChild; ) h.appendChild(a.firstChild);
            else h = a;
          ...
          return (
            J &&
              ...
              de(ze, a.ownerDocument.doctype.name) &&
              (c = "<!DOCTYPE " + a.ownerDocument.doctype.name + ">\n" + c),
            V &&
              Kt([D, N, A], (t) => {
                c = oe(c, t, " ");
              }),
    ...
    const $e = { text: ["headline", "text"], media: ["caption", "credit"] },
      Ue = { start_date: ["display_date"], end_date: ["display_date"], slide: ["display_date", "group"], date: ["display_date"] };
    function Be(t, e, i) {
    ...
    function We(t) {
      return qe.sanitize(t, { ADD_TAGS: ["iframe"], ADD_ATTR: ["frameborder", "target"] });
    }
    ...
    class Ge {
      ...
      validate() {
        (void 0 !== this.events && void 0 !== this.events.length && 0 != this.events.length) ||
          this.logError(
            "Timeline configuration has no events. Common causes for this: changing/erasing 'Year' from the A1 cell, or having 'era' in all non-title 'type' cells."
          );
        for (var t = 0; t < this.eras.length; t++) {
          var e;
          (void 0 !== this.eras[t].start_date && void 0 !== this.eras[t].end_date) ||
            ((e = this.eras[t].headline ? this.eras[t].headline : "era " + (t + 1)),
      ...
      addEvent(t, e) {
        ...
        return void 0 === t.start_date
          ? (D("Missing start date, skipping event"), console.log(t), null)
          : (this._processDates(t), this._tidyFields(t), this.events.push(t), (this.event_dict[i] = t), e || zt(this.events), i);
      }
      addEra(t) {
      ...
      _assignID(t) {
        var e = t.unique_id;
        return (
          O(e) || (e = t.text ? j(t.text.headline) : null),
      ...
      _makeUniqueIdentifiers(t, e) {
        for (var i = [t], a = 0; a < e.length; a++)
          O(e[a].unique_id) &&
            ((e[a].unique_id = j(e[a].unique_id)), -1 == i.indexOf(e[a].unique_id) ? i.push(e[a].unique_id) : (e[a].unique_id = ""));
      ...
      getLatestDate() {
        for (var t = [], e = 0; e < this.events.length; e++)
          this.events[e].end_date ? t.push({ date: this.events[e].end_date }) : t.push({ date: this.events[e].start_date });
        for (e = 0; e < this.eras.length; e++)
          this.eras[e].end_date ? t.push({ date: this.eras[e].end_date }) : t.push({ date: this.eras[e].start_date });
    ...
    function Ye(t, e) {
      return !0 !== (e = e || {}).noHeaderRow && t.length > 0
        ? { fields: t[0].map((t, e) => (t && t.trim ? t.trim() : `untitled${e}`)), records: t.slice(1) }
        : { records: t };
    }
    function Ze(t, e) {
      ...
      for (
        ...
        ((n = t.charAt(a)),
          !1 !== o || (n !== i.delimiter && n !== i.lineterminator)
            ? n !== i.quotechar
              ? (l += n)
              : o
                ? t.charAt(a + 1) === i.quotechar
                  ? ((l += i.quotechar), (a += 1))
                  : (o = !1)
                : ((o = !0), (r = !0))
            : ((l = s(l)), h.push(l), n === i.lineterminator && (d.push(h), (h = [])), (l = ""), (r = !1)));
      ...
      ((t = (function (t) {
        ...
        await (async function (t) {
                ...
                window
                  ...
                  .then(function (t) {
                    ...
                    "application/json" == t.headers.get("content-type")
                      ...
                      : i({ status_code: t.status, message: `Error fetching CSV: [${t.status} ${t.statusText}]` });
                  })
                  .then(function (i) {
                    if (i) {
                      var a = (function (t, e) {
          ...
          .catch((t) => {
            ...
            if (401 == t.status_code)
              throw new x(
                "Configuration unreadable. Please make sure your Google Sheets document is published to the web and review step 2 of the timeline setup instructions to make sure you have the correct URL, as this has changed."
              );
            if (410 == t.status_code)
              throw new x(
                "Google reports that this configuration spreadsheet is gone. Check to see if it has been deleted from Google Drive. Timeline configuration spreadsheets must not be deleted."
              );
            let e = "undefined error";
            throw ((e = Array.isArray(t.message) ? t.message.join("<br>") : String(t.message)), new x(e));
          }));
      let a = { events: [], errors: [], warnings: [], eras: [] };
      return (
        i.forEach((t, e) => {
          try {
            if (
              ...
              let e = (function (t) {
                ...
                if (Object.keys(e).includes("Start Date") || Object.keys(e).includes("End Date"))
                  (e["Start Date"] && (a.start_date = bt(e["Start Date"])), e["End Date"] && (a.end_date = bt(e["End Date"])));
                else {
                  if (
                    (e.Year && (a.start_date = { year: Ve(e.Year), month: Ve(e.Month) || "", day: Ve(e.Day) || "" }),
                    e["End Year"] && (a.end_date = { year: Ve(e["End Year"]) || "", month: Ve(e["End Month"]) || "", day: Ve(e["End Day"]) || "" }),
                    e.Time)
                  ) {
              ...
              !(function (t, e) {
                ...
                (void 0 !== t.type && ((i = t.type), delete t.type),
                  "title" == i
                    ? e.title
                      ? (e.warnings.push("Multiple title slides detected."), e.events.push(t))
                      : (e.title = t)
                    : "era" == i
                      ? e.eras.push(t)
                      : e.events.push(t));
    ...
    var ti = {},
      ei = function (t, e) {
        ...
        for (var i = 0; i < e.length - 1; i++) {
          var a = e[i],
            s = e[i + 1];
          ti[t].push(new Qe({ scale: a[3], minor: { name: a[0], factor: a[1] }, major: { name: s[0], factor: s[1] } }));
        }
      };
    ...
    class ai {
      constructor(t, e) {
        var i = t.events;
        ((this._scale = t.scale),
          (e = E({ display_width: 500, screen_multiplier: 3, max_rows: null }, e)),
      ...
      _computeRowInfo(t, e) {
        ...
        return { n_rows: i.length, n_overlaps: a };
      }
      _computePositionInfo(t, e, i) {
        i = i || 100;
        for (var a = [], s = !1, n = 0; n < t.length; n++) {
          var o = { start: this.getPosition(t[n].start_date.getTime()) };
        ...
        if (a.length) {
          s && a.push("");
          var l = [];
          for (n = 0; n < a.length; n++) l[n] = { label: a[n], idx: n, positions: [], n_rows: 1, n_overlaps: 0 };
          ...
          for (var _ = 0; n < l.length; n++) {
            for (this._group_labels.push({ label: l[n].label, rows: l[n].n_rows }), h = 0; h < l[n].positions.length; h++)
    ...
    class ni {
      constructor(t, e, i, a) {
        ((this.start_date = t),
          ...
          (this.options = { duration: 1e3, ease: Q, width: 600, height: 600, marker_width_min: 100 }),
          (this.active = !1),
          (this.animator = {}),
          (this.has_end_date = !1),
          E(this.options, a),
      ...
      setRowPosition(t, e) {
        (this.setPosition({ top: t }), e < 56 && this._el.content_container.remove("tl-timeera-content-container-small"));
      }
      setColor(t) {
    ...
    class oi {
      constructor(t, e, i) {
        (i && this.setLanguage(i),
          ...
          (this._state = { loaded: !1 }),
          (this.data = {}),
          (this.options = { duration: 1e3, ease: Q, width: 600, height: 600 }),
          (this.active = !1),
          (this.animator = {}),
          (this.axis_helper = {}),
          (this.minor_ticks = []),
      ...
      _createTickElements(t, e, i, a) {
        e.innerHTML = "";
        var s = {};
        if (((s[new Date(-1, 13, -30).getTime()] = !0), a)) for (var n = 0; n < a.length; n++) s[a[n].getTime()] = !0;
        var o = [];
        for (n = 0; n < t.length; n++) {
          ...
          if (!(r.getTime() in s)) {
            ...
            ((h.innerHTML = t), o.push({ tick: l, tick_text: h, display_date: t, date: r }));
          }
        }
        return o;
      }
        ...
        if (t[1] && t[0]) {
          ...
          for (var s = 1, n = 0; n < t.length; n++) {
            ...
            ((o.tick.style.left = e.getPosition(o.date.getMillisecond()) + "px"),
              ...
              a > 1
                ? s >= a
                  ? ((s = 1), (o.tick_text.style.opacity = 1), (o.tick.className = "tl-timeaxis-tick"))
                  : (s++, (o.tick_text.style.opacity = 0), (o.tick.className = "tl-timeaxis-tick tl-timeaxis-tick-hidden"))
                : ((o.tick_text.style.opacity = 1), (o.tick.className = "tl-timeaxis-tick")));
          }
        }
      }
      getVisibleTicks() {
        return { major: this._getVisibleTickArray(this.major_ticks), minor: this._getVisibleTickArray(this.minor_ticks) };
      }
      _getVisibleTickArray(t) {
        return t.filter(({ tick: t }) =>
          (function (t) {
    ...
    class ri {
      constructor(t, e, i) {
        ((this._el = { container: {}, content_container: {}, content: {}, headline_container: {}, headline: {}, date: {} }),
      ...
      _initLayout() {
        if (
          ((this._el.content_container = v("div", "tl-text-content-container", this._el.container)),
    ...
    class li {
      constructor(t, e, i) {
        (i && this.setLanguage(i),
          ...
          this.options.background ||
            ((this._el.container = v("div", "tl-media")), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._initLayout()));
      }
      loadMedia() {
        var t = this;
      ...
      showMeta(t, e) {
        ((this._state.show_meta = !0),
          this.data.credit &&
            "" != this.data.credit &&
            ((this._el.credit = v("div", "tl-credit", this._el.content_container)),
            (this._el.credit.innerHTML = 1 == this.options.autolink ? $(this.data.credit) : this.data.credit),
            (this.options.credit_height = this._el.credit.offsetHeight)),
          this.data.caption &&
            "" != this.data.caption &&
            ((this._el.caption = v("div", "tl-caption", this._el.content_container)),
      ...
      _initLayout() {
        ((this.message = new jt(this._el.container, this.options, this.getLanguage())),
          ...
          this.data.link && "" != this.data.link
            ? ((this._el.link = v("a", "tl-media-link", this._el.content_container)),
              ...
              (this._el.content = v("div", "tl-media-content", this._el.link)))
            : (this._el.content = v("div", "tl-media-content", this._el.content_container)));
      }
      _updateDisplay(t, e, i) {
      ...
      createMedia() {
        ...
        ((this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) && (e = "tl-media-item tl-media-image"),
          ...
          this.data.title
            ...
            : this.data.caption && (this._el.content_item.title = q(this.data.caption)),
    ...
    let ui = new (class {
      ...
      finish(t) {
        ...
        a &&
          ...
          (i = a.urls).shift(),
          (this.pollCount = 0),
          i.length || (e && e.call(a.context, a.obj), (this.pending[t] = null), this.queue[t].length && this.load(t)));
      }
      getEnv() {
      ...
      load(t, e, i, a, s) {
        var n,
          ...
          m = [];
        if (e)
          if (((e = "string" == typeof e ? [e] : e.concat()), u || this.env.async || this.env.gecko || this.env.opera))
            this.queue[t].push({ urls: e, callback: i, obj: a, context: s });
          else for (n = 0, o = e.length; n < o; ++n) this.queue[t].push({ urls: [e[n]], callback: n === o - 1 ? i : null, obj: a, context: s });
        if (!this.pending[t] && (l = this.pending[t] = this.queue[t].shift())) {
          for (n = 0, o = (h = l.urls).length; n < o; ++n)
            ((d = h[n]),
              u
                ? (r = this.env.gecko ? this.createNode("style") : this.createNode("link", { href: d, rel: "stylesheet" }))
                : ((r = this.createNode("script", { src: d })).async = !1),
              ...
              this.env.ie && !u
                ...
                : u && (this.env.gecko || this.env.webkit)
                  ? this.env.webkit
                    ? ((l.urls[n] = r.href), this.pollWebKit())
                    : ((r.innerHTML = '@import "' + d + '";'), this.pollGecko(r))
          ...
          this.data.url.match("v=")
            ...
            : this.data.url.match("/embed/")
              ...
              : this.data.url.match(/v\/|v=|youtu\.be\//)
                ...
                : D("YOUTUBE IN URL BUT NOT A VALID VIDEO"),
          this.data.url.match("start=")
            ? (this.media_id.start = V(this.data.url.split("start=")[1]))
            : this.data.url.match("t=") && (this.media_id.start = V(this.data.url.split("t=")[1])),
          this.data.url.match("end=") && (this.media_id.end = V(this.data.url.split("end=")[1])),
          (this.media_id.hd = Boolean(void 0 !== t.hd)),
          di("https://www.youtube.com/iframe_api", function () {
            e.createMedia();
          }));
      }
      _updateMediaDisplay() {
        ((this._el.content_item.style.height = W({ w: this.options.width }) + "px"), (this._el.content_item.style.width = this.options.width + "px"));
      }
      _stopMedia() {
    ...
    class _i extends li {
      ...
      _updateMediaDisplay() {
        if (this._state.loaded) {
          var t = B({ w: this._el.content_item.offsetWidth });
      ...
      makeGoogleMapsEmbedURL(t, e) {
        ...
        return (function (t) {
          function s(e, s) {
            if ("z" == e.slice(-1)) s.zoom = e;
              ...
              for (let t in a.streetview) {
                var r = parseInt(t) + 1;
                "pitch" == a.streetview[t] && "90t" == streetview_params[r]
                  ? (s[a.streetview[t]] = 0)
                  : (s[a.streetview[t]] = streetview_params[r].slice(0, -1));
              }
            }
            return s;
          }
          let n = "view";
          return (
            t.match(l.place) ? (n = "place") : t.match(l.directions) ? (n = "directions") : t.match(l.search) && (n = "search"),
            (function (t, n) {
              var o = {},
                r = n[1],
                l = n[n.length - 1];
    ...
    class fi extends li {
      ...
      createMedia(t) {
        ...
        if (t.query) {
          var i = "";
          (((e = { entry: {}, title: "", text: "", extract: "", paragraphs: 1, page_image: "", text_array: [] }).entry = (function (t) {
            if (void 0 !== t) {
              var e = 0;
              for (var i in t) {
                if (0 === e) return t[i];
          ...
          for (var a = 0; a < e.text_array.length; a++)
            a + 1 <= e.paragraphs && a + 1 < e.text_array.length && (e.text += "<p>" + e.text_array[a + 1]);
          ((i += "<span class='tl-icon-wikipedia'></span>"),
            (i += "<div class='tl-wikipedia-title'><h4><a href='" + this.data.url + "' target='_blank' rel='noopener'>" + e.title + "</a></h4>"),
    ...
    class gi extends li {
      _loadMedia() {
        var t,
          e = Math.round(this.options.width) || 1e3,
          i = this.getLanguage().lang.toLowerCase(),
          a = this;
        try {
          (this.establishMediaID(),
            (t = `https://commons.wikimedia.org/w/api.php?action=query&titles=${this.media_id}&prop=imageinfo|entityterms&iiprop=url&&iiurlwidth=${e}&format=json&origin=*&wbetlanguage=${i}`),
            ct(t, function (t) {
              let e = (function (t) {
                let e = {};
              ...
              e.url
                ? ((a.base_image_url = e.url),
                  (a.page_id = e.page_id),
                  !a.data.alt && e.label && (a.data.alt = e.label),
                  a.options.background || a.createMedia(),
                  a.onLoaded())
                : a.loadErrorDisplay(a._("wikipedia_image_load_err"));
            }));
        } catch (t) {
          ...
          mt(`https://commons.wikimedia.org/w/api.php?action=wbgetentities&format=json&ids=${e}&format=json&origin=*`).then((i) => {
            if (i.entities && i.entities[e]) {
              let a = i.entities[e].labels,
                ...
                n = null;
              (a[s] ? (n = a[s]) : s.length > 2 && a[s.substr(0, 2)] ? (n = a[s.substr(0, 2)]) : a.en && (n = a.en),
                n
                  ? (console.log(`wikibase_id: ${t.media_id} alt ${n.value}`), (t.data.alt = n.value), (t._el.content_item.alt = t.data.alt))
                  : console.log(`wikibase_id: ${t.media_id} ain't got no alt`));
            }
          });
        }
    ...
    class yi extends li {
      ...
      _updateMediaDisplay() {
        this._el.content_item.style.height = W({ w: this._el.content_item.offsetWidth }) + "px";
      }
      _stopMedia() {
        try {
          this.player &&
    ...
    class bi extends li {
      _loadMedia() {
        ...
        ((this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-dailymotion", this._el.content)),
          -1 != this.data.url.indexOf("dai.ly/")
            ? (this.media_id = this.data.url.substr(this.data.url.indexOf("dai.ly/") + 7))
            : this.data.url.match("video")
              ? (this.media_id = this.data.url.split("video/")[1].split(/[?&]/)[0])
              : (this.media_id = this.data.url.split("embed/")[1].split(/[?&]/)[0]),
          -1 != this.media_id.indexOf("_") && (this.media_id = this.media_id.split("_")[0]),
      ...
      _updateMediaDisplay() {
        this._state.loaded && (this._el.content_item.style.height = W({ w: this._el.content_item.offsetWidth }) + "px");
      }
      _stopMedia() {
    ...
    class wi extends li {
      ...
      _updateMediaDisplay() {
        var t = B({ w: this._el.content_item.offsetWidth, h: this.options.height });
        this._el.content_item.style.height = t.h + "px";
      }
      _stopMedia() {
    ...
    class ki extends li {
      _loadMedia() {
        ...
        if (
          ...
          (this._el.content_container.className = "tl-media-content-container tl-media-content-container-text"),
          this.data.url.match("^(https?:)?/*(www.)?(twitter|x).com"))
        )
      ...
      createMedia(t) {
        ...
        ((n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
          ...
          (i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0]),
          (a = o.split('">')[1].split("</a>")[0]),
          (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") || n.includes("pic.x.com")
            ? (di("https://platform.twitter.com/widgets.js", function () {
                twttr.widgets.createTweet(r.media_id, r._el.content_item, { conversation: "none", linkColor: "#cc0000", theme: "light" });
              }),
              this.onLoaded())
            : ((s += n),
              (s += "<div class='vcard'>"),
              (s += "<a href='" + i + "' class='twitter-date' rel='noopener' target='_blank'>" + a + "</a>"),
              (s += "<img src='' class='tl-media-item tl-media-image'></a>"),
              (s += "<div class='author'>"),
              (s += "<a class='screen-name url' href='" + t.author_url + "' rel='noopener' target='_blank'>"),
              (s += "<span class='avatar'></span>"),
              (s += "<span class='fn'>" + t.author_name + " <span class='tl-icon-twitter'></span></span>"),
              (s += "<span class='nickname'>@" + e + "<span class='thumbnail-inline'></span></span>"),
              (s += "</a>"),
              (s += "</div>"),
              (s += "</div>"),
              (this._el.content_item.innerHTML = s),
              this.onLoaded()));
      }
      updateMediaDisplay() {}
      _updateMediaDisplay() {}
    ...
    class xi extends li {
        ...
        l && l.length > 2
          ? ((this.media_id = l[2]),
            ...
            (window.twttr =
              ((a = "script"),
              (s = "twitter-wjs"),
              (o = (i = document).getElementsByTagName(a)[0]),
              (r = window.twttr || {}),
              i.getElementById(s) ||
                (((n = i.createElement(a)).id = s),
      ...
      createMedia(t) {
        ...
        ((n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
          ...
          (i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0]),
          (a = o.split('">')[1].split("</a>")[0]),
          (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')));
        let r = this.media_id;
        n.includes("pic.twitter.com")
          ? (twttr.ready(function (t) {
              s = document.getElementsByClassName("tl-media-twitter")[0];
              var e = String(r);
              twttr.widgets.createTweet(e, s, { conversation: "none", linkColor: "#cc0000", theme: "light" }).then(function (t) {
                this.onLoaded();
              });
            }),
            (this._el.content_item.innerHTML = s),
    ...
    class Ti extends li {
      _loadMedia() {
        ...
        try {
          (this.establishMediaID(),
            ...
            ct(t, function (t) {
              "ok" == t.stat
                ? ((e.sizes = t.sizes.size), e.options.background || e.createMedia(), e.onLoaded())
      ...
      getImageURL(t, e) {
        for (var i = this.size_label(e), a = this.sizes[this.sizes.length - 2].source, s = 0; s < this.sizes.length; s++)
          this.sizes[s].label == i && (a = this.sizes[s].source);
        return a;
      }
      _getMeta() {
        var t,
        ...
        ((t =
          ...
          "&format=json&jsoncallback=?"),
          ct(t, function (t) {
            ((e.data.credit_alternate = "<a href='" + e.data.url + "' target='_blank' rel='noopener'>" + t.photo.owner.realname + "</a>"),
              (e.data.caption_alternate = t.photo.title._content + " " + t.photo.description._content),
              e.updateMeta());
          }));
      }
      size_label(t) {
      ...
      _loadMedia() {
        ...
        ((this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content)),
          ...
          this.data.url.match(/\.html$/)
            ...
            : this.data.url.match(/.(json|js)$/) || D("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"),
          di(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], function () {
            t.createMedia();
          }));
      }
      _transformURL(t) {
    ...
    class Di extends li {
      ...
      createMedia() {
        ...
        try {
          ut({ url: t, dataType: "json", success: Li, error: Si, context: this });
        } catch (e) {
    ...
    class Ai extends li {
      _loadMedia() {
        ...
        ((this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe", this._el.content)),
          (t = this.data.url.match(/open\?id=([^&]+)/)
            ? "https://drive.google.com/file/d/" + this.data.url.match(/open\?id=([^&]+)/)[1] + "/preview"
            : this.data.url.match(/file\/d\/([^/]*)\/?/)
              ? "https://drive.google.com/file/d/" + this.data.url.match(/file\/d\/([^/]*)\/?/)[1] + "/preview"
              : this.data.url),
    ...
    class Ii extends li {
      _loadMedia() {
        ...
        ((this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-spotify", this._el.content)),
          (this.media_id = (e = this.data.url).match(/^spotify:/) ? e : `spotify${(e = new URL(e)).pathname.replace(/\/$/, "").replace(/\//g, ":")}`),
          this.media_id
      ...
      _updateMediaDisplay(t) {
        var e = this.options.height,
          i = 0,
          a = 0;
        ((e = h ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30),
          (this._el.content_item.style.maxHeight = "none"),
          D(e),
          D(this.options.width),
          e > this.options.width
            ? (D("height is greater"), (i = this.options.width + 80 + "px"), (a = this.options.width + "px"))
            : (D("width is greater"), D(this.options.width), (i = e + "px"), (a = e - 80 + "px")),
          (this.player.style.width = a),
          (this.player.style.height = i),
          this._el.credit && (this._el.credit.style.width = a),
          this._el.caption && (this._el.caption.style.width = a));
      }
      _stopMedia() {}
    }
    class Ci extends li {
      constructor(t, e, i) {
        (super(t, e, i), (this.iframe = qe.sanitize(this.data.url, { ADD_TAGS: ["iframe"], ADD_ATTR: ["frameborder"] })));
      }
      _loadMedia() {
        ((this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe", this._el.content)),
    ...
    class Oi extends li {
      ...
      _updateMediaDisplay() {
        ((this._el.content_item.style.width = this.options.width + "px"), (this._el.content_item.style.height = W({ w: this.options.width }) + "px"));
      }
    }
    class Ri extends li {
      _loadMedia() {
    ...
    class ji extends li {
      ...
      createMedia() {
        var t = U(this.data.url),
          e = this;
        ((this._el.content_item = this.domCreate("audio", "tl-media-item tl-media-audio tl-media-shadow", this._el.content)),
    ...
    class zi extends li {
      ...
      createMedia() {
        var t = U(this.data.url),
          e = this;
        ((this._el.content_item = this.domCreate("video", "tl-media-item tl-media-video tl-media-shadow", this._el.content)),
          (this._el.content_item.controls = !0),
          (this._el.source_item = this.domCreate("source", "", this._el.content_item)),
          this._el.content_item.addEventListener("load", function (t) {
            e.onMediaLoaded();
    ...
    class Pi extends li {
      _loadMedia() {
        ...
        ((this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-wistia tl-media-shadow", this._el.content)),
          ...
          D(`Wistia: media_id: ${this.media_id}`),
    ...
    function Hi(t, e) {
      var i = [
        { type: "youtube", name: "YouTube", match_str: "^(https?:)?/*(www.|m.)?youtube|youtu.be", cls: mi },
        { type: "vimeo", name: "Vimeo", match_str: "^(https?:)?/*(player.)?vimeo.com", cls: yi },
        { type: "dailymotion", name: "DailyMotion", match_str: "^(https?:)?/*(www.)?(dailymotion.com|dai.ly)", cls: bi },
        { type: "vine", name: "Vine", match_str: "^(https?:)?/*(www.)?vine.co", cls: wi },
        { type: "soundcloud", name: "SoundCloud", match_str: "^(https?:)?/*(player.)?soundcloud.com", cls: vi },
        { type: "twitter", name: "Twitter", match_str: "^(https?:)?/*(www.)?(twitter|x).com", cls: ki },
        { type: "twitterembed", name: "TwitterEmbed", match_str: "<blockquote class=['\"]twitter-tweet['\"]", cls: xi },
        {
          type: "googlemaps",
          name: "Google Map",
          match_str:
        ...
        { type: "flickr", name: "Flickr", match_str: "^(https?:)?/*(www.)?flickr.com/photos", cls: Ti },
        { type: "flickr", name: "Flickr", match_str: "^(https?://)?flic.kr/.*", cls: Ti },
        { type: "instagram", name: "Instagram", match_str: /^(https?:)?\/*(www.)?(instagr.am|^(https?:)?\/*(www.)?instagram.com)\/p\//, cls: Di },
        {
          type: "profile",
          name: "Profile",
        ...
        { type: "documentcloud", name: "Document Cloud", match_str: /documentcloud.org\//, cls: Mi },
        {
        ...
        { type: "wikipedia", name: "Wikipedia", match_str: "^(https?:)?/.+.wikipedia.org", cls: fi },
        { type: "image", name: "Image", match_str: /(jpg|jpeg|png|gif|svg|webp)(\?.*)?$/i, cls: hi },
        { type: "imgur", name: "Imgur", match_str: /^.*imgur.com\/.+$|<blockquote class=['\"]imgur-embed-pub['\"]/i, cls: Oi },
        {
          type: "googledocs",
          name: "Google Doc",
          match_str:
        ...
        { type: "pdf", name: "PDF", match_str: /^.*\.pdf(\?.*)?(\#.*)?/, cls: Ri },
        { type: "spotify", name: "spotify", match_str: "spotify", cls: Ii },
        { type: "iframe", name: "iFrame", match_str: "iframe", cls: Ci },
        { type: "blockquote", name: "Quote", match_str: "blockquote", cls: pi },
        { type: "video", name: "Video", match_str: /(mp4|webm)(\?.*)?$/i, cls: zi },
        { type: "wistia", name: "Wistia", match_str: /https?:\/\/(.+)?(wistia\.com|wi\.st)\/.*/i, cls: Pi },
        { type: "audio", name: "Audio", match_str: /(mp3|wav|m4a)(\?.*)?$/i, cls: ji },
        { type: "imageblank", name: "Imageblank", match_str: "", cls: hi },
      ];
      if (e) {
      ...
      } else for (a = 0; a < i.length; a++) if (t.url.match(i[a].match_str)) return i[a];
      return !1;
    }
    class Fi {
      constructor(t, e) {
      ...
      getFormattedDate() {
        ...
        let t = "";
        return (
          this.data.end_date && (t = " to " + this.data.end_date.getDisplayDate(this.getLanguage())),
      ...
      _onMarkerKeydown(t) {
        /Space|Enter/.test(t.code) && this.fire("markerclick", { unique_id: this.data.unique_id });
      }
      _onMarkerBlur(t) {
      ...
      _initLayout() {
        if (
          ((this._el.container = v("div", "tl-timemarker")),
        ...
        ((this._el.text = v("div", "tl-timemarker-text", this._el.content)),
          ...
          this.data.text.headline && "" != this.data.text.headline
            ? (this._text.innerHTML = F(this.data.text.headline))
            : this.data.text.text && "" != this.data.text.text
              ? (this._text.innerHTML = F(this.data.text.text))
              : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = F(this.data.media.caption)));
    ...
    class qi {
      ...
      _momentum() {
        ...
        ((this.data.direction = null),
          ...
          i.x &&
            (Math.abs(e.x) > this._el.drag.offsetWidth / 2 && (a = !0),
            Math.abs(e.x) > 1e4 && ((this.data.direction = "left"), e.x > 0 && (this.data.direction = "right"))),
          i.y &&
            (Math.abs(e.y) > this._el.drag.offsetHeight / 2 && (a = !0),
            Math.abs(e.y) > 1e4 && ((this.data.direction = "up"), e.y > 0 && (this.data.direction = "down"))),
          e.time < 1e3 || this._animateMomentum(),
          a && this.data.direction
    ...
    class $i {
      ...
      updateDisplay(t, e, i) {
        let a = !1;
        (t && (0 == this.options.width && t > 0 && (a = !0), (this.options.width = t)),
      ...
      _getTimeScale() {
        ...
        return (
          0 == t && (D("marker_height_min option must not be zero."), (t = 30)),
      ...
      zoomOut() {
        var t = (function (t, e) {
          for (var i = t.length - 1; i >= 0; i--) if (e > t[i]) return t[i];
          return e;
        })(this.options.zoom_sequence, this.options.scale_factor);
        this.setZoomFactor(t);
      }
      ...
      _positionGroups() {
        if (this.options.has_groups)
          for (
            var t = this.options.height - this._el.timeaxis_background.offsetHeight,
            ...
            (s > t - this.options.marker_padding && (n = !0),
              ...
              this._groups[i].setAlternateRowColor(P(i), n),
      ...
      _calculateMinimumTimeNavHeight() {
        return (
          this.timescale.getNumberOfRows() * this.options.marker_height_min + this._el.timeaxis_background.offsetHeight + this.options.marker_padding
        );
      }
      getMinimumHeight() {
      ...
      _positionEras(t) {
        for (var e = 0, i = 0; i < this._eras.length; i++) {
          ...
          ((a.start = this.timescale.getPosition(this._eras[i].start_date.getTime())),
            ...
            this._eras[i].setPosition({ left: a.start }),
      ...
      goTo(t, e, i) {
        ...
        (this._resetMarkersActive(),
          ...
          t >= 0 && t < this._markers.length
            ? (this.current_id = this.current_focused_id = this._markers[t].data.unique_id)
        ...
        (this.animator && this.animator.stop(),
          e
            ? ((this._el.slider.className = "tl-timenav-slider"),
              (this._el.slider.style.left = -this._markers[t].getLeft() + this.options.width / 2 + "px"))
            : i
              ? ((this._el.slider.className = "tl-timenav-slider tl-timenav-slider-animate"),
                (this.animate_css = !0),
                (this._el.slider.style.left = -this._markers[t].getLeft() + this.options.width / 2 + "px"))
              : ((this._el.slider.className = "tl-timenav-slider"),
                (this.animator = st(this._el.slider, { left: -this._markers[t].getLeft() + this.options.width / 2 + "px", duration: a, easing: s }))),
      ...
      _dispatchVisibleTicksChange() {
        (this.ticks_change_timeout && (clearTimeout(this.ticks_change_timeout), (this.ticks_change_timeout = null)),
          (this.ticks_change_timeout = setTimeout(() => {
            const t = this.timeaxis.getVisibleTicks();
            this.fire("visible_ticks_change", { visible_ticks: t });
      ...
      _onMouseScroll(t) {
        var e = 0,
          i = 0,
          a = { right: -(this.timescale.getPixelWidth() - this.options.width / 2), left: this.options.width / 2 };
        (t || (t = window.event),
      ...
      _initLayout() {
        ((this._el.line = v("div", "tl-timenav-line", this._el.container)),
          ...
          (this.timeaxis = new oi(this._el.timeaxis, this.options, this.language)),
          (this._swipable = new qi(this._el.slider_background, this._el.slider, {
            enable: { x: !0, y: !1 },
            constraint: { top: !1, bottom: !1, left: this.options.width / 2, right: !1 },
            snap: !1,
          })),
      ...
      _initData() {
        (this._createMarkers(this.config.events),
          this.config.eras && this.config.eras.length > 0 && ((this.has_eras = !0), this._createEras(this.config.eras)),
          this._drawTimeline());
      }
    }
    (R($i, at, ot, Rt), i(142));
    class Ui {
      constructor(t, e, i, a) {
        (a && this.setLanguage(a),
          ...
          (this.options = { duration: 1e3, slide_padding_lr: 40, ease: Q, width: 600, height: 600, skinny_size: 650, media_name: "" }),
          (this.active = !1),
          (this.animator = {}),
          E(this.options, e),
          E(this.data, t),
      ...
      setActive(t) {
        ((this.active = t),
          this.active
            ? (this.data.background && this.fire("background_change", this.has.background), this._setInteractive(!0), this.loadMedia())
      ...
      updateDisplay(t, e, i) {
        ...
        ((this.options.width = t || this._el.container.offsetWidth),
          ...
          h && this.options.width <= this.options.skinny_size
            ? ((s = 0), (n = 0), (a = this.options.width))
            : "landscape" == i || (this.options.width <= this.options.skinny_size && ((s = 50), (n = 50), (a = this.options.width - s - n))),
          ...
          this._media &&
            (!this.has.text && this.has.headline
              ? this._media.updateDisplay(a, this.options.height - this._text.headlineHeight(), i)
              : this.has.text || this.has.headline
                ? this.options.width <= this.options.skinny_size
                  ? this._media.updateDisplay(a, this.options.height, i)
                  : this._media.updateDisplay(a / 2, this.options.height, i)
                : this._media.updateDisplay(a, this.options.height, i)),
      ...
      getFormattedDate() {
        ...
        return (
          this.has.title ||
            (this.data.end_date && (t = " &mdash; " + this.data.end_date.getDisplayDate(this.getLanguage())),
      ...
      _initLayout() {
        if (
          ((this._el.container = v("div", "tl-slide")),
          ...
          if (this.data.background.url) {
            ...
            (t &&
              ...
              this.data.background.alt &&
                (this._el.background.setAttribute("role", "img"), this._el.background.setAttribute("aria-label", this.data.background.alt)));
          }
        ...
        (this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0),
          ...
          this.has.media &&
            ((this.data.media.mediatype = Hi(this.data.media)),
            (this.options.media_name = this.data.media.mediatype.name),
            (this.options.media_type = this.data.media.mediatype.type),
            (this.options.autolink = this.data.autolink),
            (this._media = new this.data.media.mediatype.cls(this.data.media, this.options, this.getLanguage()))),
          (this.has.text || this.has.headline) &&
            ((this._text = new ri(this.data.text, { title: this.has.title, language: this.getLanguage(), autolink: this.data.autolink })),
            this._text.addDateText(this.getFormattedDate())),
          this.has.text || this.has.headline || !this.has.media
            ? this.has.headline && this.has.media && !this.has.text
              ? (this._el.container.classList.add("tl-slide-media-only"), this._text.addTo(this._el.content), this._media.addTo(this._el.content))
              : this.has.text && this.has.media
                ? (this._text.addTo(this._el.content), this._media.addTo(this._el.content))
                : (this.has.text || this.has.headline) && (this._el.container.classList.add("tl-slide-text-only"), this._text.addTo(this._el.content))
            : (this._el.container.classList.add("tl-slide-media-only"), this._media.addTo(this._el.content)),
          this.onLoaded());
      }
      _initEvents() {}
    ...
    class Wi {
      constructor(t, e, i, a) {
        (a && this.setLanguage(a),
          ...
          "object" == typeof t ? ((this._el.container = t), (this.options.id = z(6, "tl"))) : ((this.options.id = t), (this._el.container = g(t))),
      ...
      updateDisplay(t, e, i, a) {
        ...
        ((n = void 0 === a ? this.options.layout : a),
          ...
          this._nav.next.setPosition({ top: s }),
          this._nav.previous.setPosition({ top: s }));
        for (var o = 0; o < this._slides.length; o++)
          (this._slides[o].updateDisplay(this.options.width, this.options.height, n),
            this._slides[o].setPosition({ left: this.slide_spacing * o, top: 0 }));
      ...
      goTo(t, e, i) {
        ...
        t < this._slides.length &&
          ...
          this._slides[t - 1]
            ? (this.showNav(this._nav.previous, !0), this._nav.previous.update(this._slides[t - 1]))
      ...
      changeBackground(t) {
        ...
        (t.color_value && "" != t.color_value
          ? (e = M(t.color_value)) || (D("Invalid color value " + t.color_value), (e = this.options.default_bg_color))
      ...
      _updateDrawSlides() {
        for (var t = this.options.layout, e = 0; e < this._slides.length; e++)
          (this._slides[e].updateDisplay(this.options.width, this.options.height, t),
            this._slides[e].setPosition({ left: this.slide_spacing * e, top: 0 }));
        this.goToId(this.current_id, !0, !1);
      }
      _initLayout() {
        (this._el.container.classList.add("tl-storyslider"),
          (this._nav.previous = new Bi({ title: "Previous", description: "description" }, { direction: "previous" }, this._el.container)),
          (this._nav.next = new Bi({ title: "Next", description: "description" }, { direction: "next" }, this._el.container)),
          ...
          f &&
            ((this._swipable = new qi(this._el.slider_container_mask, this._el.slider_container, { enable: { x: !0, y: !1 }, snap: !0 })),
            this._swipable.enable(),
            (this._message = new jt(
              this._el.container,
              { message_class: "tl-message-full", message_icon_class: "tl-icon-swipe-left" },
              this.getLanguage()
            )),
        ...
        if (this._loaded) {
          ...
          ((e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e),
            this.hasEventListeners(e) &&
              ("contextmenu" === e && ht.preventDefault(t), this.fire(e, { latlng: "something", layerPoint: "something else" })));
        }
      }
      _onLoaded() {
        this.fire("loaded", this.data);
    ...
    class Gi {
      constructor(t, e, i, a) {
        ((this._el = {
          ...
          (this.options = { width: 600, height: 600, duration: 1e3, ease: et, menubar_default_y: 0 }),
          (this.animator = {}),
          this.setLanguage(a),
          E(this.options, i),
          this._initLayout(),
      ...
      changeVisibleTicks(t) {
        ...
        ((this.data.visible_ticks_dates = { start: i, end: a }), this._updateZoomAriaLabels());
      }
      setSticky(t) {
      ...
      _updateZoomAriaLabels() {
        0 == Object.keys(this.data.visible_ticks_dates).length
          ? (this._el.button_zoomin.setAttribute("aria-description", ""), this._el.button_zoomout.setAttribute("aria-description", ""))
          : (this._el.button_zoomin.setAttribute("aria-description", this._("aria_label_zoomin", this.data.visible_ticks_dates)),
    ...
    class Zi {
      constructor(t, e, i) {
        if (
          (i || (i = {}),
          (this.ready = !1),
          (this._el = { container: g(t), storyslider: {}, timenav: {}, menubar: {} }),
          ...
          (this.message = new jt(this._el.container, { message_class: "tl-message-full" })),
        ...
        (E(this.options, i),
          ...
          i.soundcite &&
            this.on("ready", () => {
              (D("Loading Soundcite resources "),
                ci("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"),
                di("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js"));
            }),
          this._loadStyles(),
          ...
          this.options.debug && ((n = console.log), S.push(n)),
      ...
      _loadStyles() {
        ...
        if ((t && ci(t), this.options.theme && (0 == this.options.theme.indexOf("http") || this.options.theme.match(/\.css$/))))
      ...
      _loadLanguage(t) {
        try {
          ...
          (async function (t, e) {
            ...
            (i
              ? ((this.language = i), this.message.setLanguage(this.language), this.showMessage(this._("loading_timeline")))
      ...
      _initData(t) {
        "string" == typeof t
          ? (async function (t, e) {
              let i = null,
                a = {};
              if (((a = e), (i = e.callback), "function" == typeof a.callback && (i = a.callback), !i))
                throw new x(
              ...
              if (Xe(t)) {
                try {
                  ...
                  return (
                    (s = new Ge()),
                    "NetworkError" == t.name
                      ? s.logError(new x("network_err"))
                      : "TLError" == t.name
                        ? s.logError(t)
                        : s.logError(new x("unknown_read_err", t.name)),
                    void i(s)
                  );
                }
                if (((s = new Ge(n)), n.errors)) for (var o = 0; o < n.errors.length; o++) s.logError(n.errors[o]);
                i(s);
              } else
                ut({
                  url: t,
        ...
        (this.message.removeFrom(this._el.container),
          ...
          "top" == this.options.timenav_position
            ? ((this._el.timenav = v("div", "tl-timenav", this._el.container)),
              ...
              (this._el.storyslider = v("div", "tl-storyslider", this._el.container)))
            : ((this._el.storyslider = v("div", "tl-storyslider", this._el.container)),
              (this._el.timenav = v("div", "tl-timenav", this._el.container)),
              (this._el.menubar = v("div", "tl-menubar", this._el.container))),
          ...
          (this._timenav = new $i(this._el.timenav, this.config, this.options, this.language)),
          this._timenav.on("loaded", this._onTimeNavLoaded, this),
          (this._timenav.options.height = this.options.timenav_height),
          this._timenav.init(),
          this.options.initial_zoom && this.setZoom(this.options.initial_zoom),
          (this._storyslider = new Wi(this._el.storyslider, this.config, this.options, this.language)),
          ...
          (this._menubar = new Gi(this._el.menubar, this._el.container, this.options, this.getLanguage())),
      ...
      _onForwardToEnd(t) {
        (this.goToEnd(), this.fire("forward_to_end", { unique_id: this.current_id }, this));
      }
      _onBackToStart(t) {
        (this.goToStart(), this.fire("back_to_start", { unique_id: this.current_id }, this));
      }
      _onZoomIn(t) {
      ...
      _updateDisplay(t, e, i) {
        ...
        (i && (n = i),
          ...
          (this.options.height = this._el.container.offsetHeight),
          this.options.width <= this.options.skinny_size
            ? ((o += " tl-skinny"), (this.options.layout = "portrait"))
            : this.options.width <= this.options.medium_size
              ? ((o += " tl-medium"), (this.options.layout = "landscape"))
              : (this.options.layout = "landscape"),
          f &&
            (this.options.layout = ((a = "portrait"), window.innerWidth > window.innerHeight && (a = "landscape"), Math.abs(window.orientation), a)),
          h
            ? ((o += " tl-mobile"), (this.options.timenav_height = this._calculateTimeNavHeight(t, this.options.timenav_mobile_height_percentage)))
          ...
          (s =
            "top" == this.options.timenav_position
              ...
              : Math.round(
                  this.options.storyslider_height + 1 + Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 17.5
                )),
          e
            ? ((this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px"),
              this.animator_storyslider && this.animator_storyslider.stop(),
              (this.animator_storyslider = st(this._el.storyslider, { height: this.options.storyslider_height + "px", duration: n / 2, easing: tt })),
              this.animator_menubar && this.animator_menubar.stop(),
              (this.animator_menubar = st(this._el.menubar, { top: s + "px", duration: n / 2, easing: tt })))
            : ((this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px"),
      ...
      _calculateTimeNavHeight(t, e) {
        ...
        return (
          (this.options.timenav_height_percentage || e) &&
            (i = e ? Math.round((this.options.height / 100) * e) : Math.round((this.options.height / 100) * this.options.timenav_height_percentage)),
          this._timenav.ready &&
      ...
      _validateOptions() {
        for (
          ...
          ("number" == typeof a ? (s = a == parseInt(a)) : "string" == typeof a && (s = a.match(/^\s*(\-?\d+)?\s*$/)),
            s || this.config.logError({ message_key: "invalid_integer_option", detail: i }));
        }
      }
      _getSlideIndex(t) {
        if (this.config) {
      ...
      _onLoaded() {
        if (
          ...
          (null != (t = this.options.start_at_end) && (1 == t || "true" == String(t).toLowerCase() || 1 == Number(t))) ||
      ...
      _updateHashBookmark(t) {
        if (t) {
          ...
          (window.history.replaceState(null, "Browsing TimelineJS", e),
            this.fire("hash_updated", { unique_id: this.current_id, hashbookmark: "#event-" + t.toString() }, this));
        }
      }
      zoomIn() {
      ...
      _initGoogleAnalytics(t) {
        (di(`https://www.googletagmanager.com/gtag/js?id=${t}`),
    ...
    async function Vi(t, e) {
      return (e || (e = "https://sheets-proxy.knightlab.com/proxy/"), await Ke(t, { sheets_proxy: e }));
    }
    R(Zi, Rt, at);
  })(),
    (TL = a));
